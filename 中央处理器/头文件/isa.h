...
`ifndef __ISA_HEADER__
	`define __ISA_HEADER__			 // 包含文件防范

//------------------------------------------------------------------------------
// 指令
//------------------------------------------------------------------------------
	/********** 指令 **********/
	`define ISA_NOP			   32'h0 // 无操作
	/********** 操作码 **********/
	// 总线
	`define ISA_OP_W		   6	 // 操作码宽
	`define IsaOpBus		   5:0	 // 操作码总线
	`define IsaOpPosit		   31:26 // 操作码位置
	// 操作码
	...
	`define IsaRaAddrPosit	   25:21 // 寄存器Ra的位置
	`define IsaRbAddrPosit	   20:16 // 寄存器Rb的位置
	`define IsaRcAddrPosit	   15:11 // 寄存器Rc的位置
	/********** 立即数 **********/
	// 总线
