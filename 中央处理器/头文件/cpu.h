...
//------------------------------------------------------------------------------
	...
	/********** 位图 **********/
	`define CregExeModePosit		 0	   // 执行模式的位置
	`define CregIntEnablePosit	 1	   // 中断有效的位置
	`define CregExpCodePosit		 2:0   // 异常代码的位置
	`define CregDlyFlagPosit		 3	   // 延迟间隙标志位的位置
...
//------------------------------------------------------------------------------
	...
	`define ShAmountPosit			 4:0   // 移位量的位置
